...
But I still believe in Gatsby and really want to keep going. I just can't afford to spend time in debugging and configuration at this time. All I want for now is something that looks good by default so I don't need a lot of customisation to start writing.
